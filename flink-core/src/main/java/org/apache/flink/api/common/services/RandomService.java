...
public interface RandomService {
	...
	/**
	 * Calls nextInt(int maxExclusive), passing in the integer max
	 */
	int nextInt();

	/**
	 *  Generates a random number from 0 up to and not including <i>maxExclusive</i>.
	 *  During causal recovery, if the implementation is causal, returns the previously returned number.
	 * @param maxExclusive the upper bound for RNG
	 */
